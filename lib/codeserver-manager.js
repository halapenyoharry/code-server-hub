...
const CODE_SERVER_DATA_ROOT = process.env.CODE_SERVER_DATA_DIR || pathConfig.CODE_SERVER_DATA || path.join(require('os').homedir(), 'code-server-data');
...
class CodeServerManager {
  ...
  async startInstance(port) {
    ...
    await this.applyDefaultSettings(dataDir);
...
enable-proposed-api: ["ms-vscode.vscode-js-profile-flame", "ms-vscode.vscode-js-profile-table"]
